...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/numpyro-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10970&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/numpyro-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `numpyro` can be installed with:

```
conda install numpyro
```

It is possible to list all of the versions of `numpyro` available on your platform with:
